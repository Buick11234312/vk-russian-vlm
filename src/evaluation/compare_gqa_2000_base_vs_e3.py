...
BASE_PATH = Path("results/base_2000/gqa_predictions.jsonl")
NEW_PATH = Path("results/adapter_8000_testdev_2000/gqa_predictions.jsonl")
...
def main() -> None:
    ...
    print("=" * 80)
    print("PAIRED GQA TESTDEV COMPARISON: BASE VS E3")
    print("=" * 80)
