...
ADAPTER_DIR = Path("outputs/pilot_lora_completion_only")

SAMPLE_PATH = Path("data/splits/gqa_baseline_sample.json")
BASELINE_SUMMARY_PATH = Path("results/baseline/gqa_summary.json")
OUTPUT_PATH = Path("results/completion_only/gqa_predictions.jsonl")
SUMMARY_PATH = Path("results/completion_only/gqa_summary.json")
