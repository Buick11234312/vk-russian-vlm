...
BASE_PATH = Path("results/validation_1982/adapter/gqa_predictions.jsonl")
NEW_PATH = Path("results/validation_1982_e3/adapter/gqa_predictions.jsonl")
...
def main() -> None:
    ...
    print("=" * 80)
    print("PAIRED GQA VALIDATION COMPARISON: E2 VS E3")
    print("=" * 80)
